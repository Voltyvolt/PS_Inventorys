<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="frmEdit.aspx.cs" Inherits="PS_Inventorys.frmEdit" %>
                    ...
                    <header class="panel-heading">
                        <div class="panel-header">
                            <div class="col-md-10 col-md-offset-4">
                                <h1>แบบฟอร์มแก้ไขคอมพิวเตอร์โรงงาน</h1>
                            </div>
                        </div>
                    </header>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" Enabled="False" CssClass="form-control" placeholder="เลขที่" ID="txtNo"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <div class="dropdown">
                                            <asp:DropDownList runat="server" placeholder="ชื่อแผนก" AutoPostBack="true" ID="cmbFacName" CssClass="form-control" OnSelectedIndexChanged="cmbFacName_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" Enabled="true" CssClass="form-control" placeholder="รหัสพนักงาน" ID="txtEmpID"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" Enabled="true" CssClass="form-control" placeholder="โปรแกรม Media" ID="txtMediaBrand"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label Text="โปรแกรม Pdf" runat="server"></asp:Label>
                                        <asp:TextBox runat="server" Enabled="true" Text="PDF-XCutter" CssClass="form-control" placeholder="โปรแกรม Pdf" ID="txtPdfBrand"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
